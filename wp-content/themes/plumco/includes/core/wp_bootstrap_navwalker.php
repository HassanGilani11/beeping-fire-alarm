<?php
/**
 * Class Name: plumco_wp_bootstrap_navwalker
...
class plumco_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'.esc_html__( 'Add a menu','plumco' ).'</a></li>';
			$fb_output .= '</ul>';
