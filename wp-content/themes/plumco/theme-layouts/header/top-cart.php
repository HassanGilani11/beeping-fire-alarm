...
<div class="mini-cart">
    <button class="cart-toggle-btn"> <i class="fi flaticon-shopping-basket"></i> <span class="cart-count"><?php echo esc_html( WC()->cart->get_cart_contents_count() ); ?></span></button>
    <div class="mini-cart-content">
        ...
        <?php else : ?>
          <span class="no-products"><?php echo esc_html__(' No products in the cart.','plumco' ); ?></span>
        <?php endif; ?>
        <div class="mini-cart-action clearfix">
            <span class="mini-checkout-price"><?php echo WC()->cart->get_cart_total(); ?></span>
             ...
             <?php } else { ?>
               <a href="<?php  echo esc_url( $mini_shop_url ) ?>" class="view-cart-btn"><?php echo esc_html__('Go Shop','plumco' ); ?>
            </a>
            <?php } ?>
        </div>
    </div>
