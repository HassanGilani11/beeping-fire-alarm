...
get_header();
	...
	// Theme Options
	$plumco_sidebar_position = cs_get_option( 'project_sidebar_position' );
	$plumco_single_comment = cs_get_option( 'project_comment_form' );
	...
	if ( $plumco_sidebar_position === 'sidebar-hide' ) {
		$plumco_layout_class = 'col-lg-10 offset-lg-1';
		$plumco_sidebar_class = 'hide-sidebar';
	} elseif ( $plumco_sidebar_position === 'sidebar-left' ) {
		$plumco_layout_class = 'col col-lg-8 order-lg-2';
		$plumco_sidebar_class = 'left-sidebar';
	} else {
		$plumco_layout_class = 'col col-lg-8';
		$plumco_sidebar_class = 'right-sidebar';
	} ?>
<div class="project-single-section section-padding <?php echo esc_attr( $plumco_content_padding .' '. $plumco_sidebar_class ); ?>" style="<?php echo esc_attr( $plumco_custom_padding ); ?>">
	<div class="container">
		<div class="row">
