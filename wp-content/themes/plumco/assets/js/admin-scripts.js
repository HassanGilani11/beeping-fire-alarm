/*
 * All Admin Related Scripts in this Plumco Theme
...
"use strict";
  ...
  /*---------------------------------------------------------------*/
   function plumco_gutenberg_toggle_metaboxes() {
  ...
  function plumco_toggle_metaboxes() {
  ...
  $(document).ready(function() {
      plumco_gutenberg_toggle_metaboxes();
      plumco_toggle_metaboxes();
    $('#post-formats-select input[type="radio"]').on('click', plumco_toggle_metaboxes);
  });
