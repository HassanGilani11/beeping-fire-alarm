...
$cfg['blowfish_secret']					= 'DI#;Y#,xe(LH]2h0x|43H~G`n}ILS>Bh' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_9sy5RNKOrnjBI8pW23HYkwq/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://divlogic.tech/wp-admin/?rand=19080793&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://divlogic.tech/wp-admin/?rand=85976786&pma_logout=1';
