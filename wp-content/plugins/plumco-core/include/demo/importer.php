 ...
 */
function plumco_import_files() {
  return array(
    array(
      'import_file_name'           => 'Plumco',
      'import_file_url'            => trailingslashit( PLUMCO_PLUGIN_URL ) . 'include/demo/content.xml',
      'local_import_csf'           => array(
        array(
          'file_path'   => trailingslashit( PLUMCO_PLUGIN_URL ) . 'include/demo/theme-options.json',
          'option_name' => '_cs_options',
        ),
      ),
      'import_widget_file_url'     => trailingslashit( PLUMCO_PLUGIN_URL ) . 'include/demo/widget.wie',
      'preview_url'                => 'https://wpocean.com/wp/plumco/',
      'import_notice'                => '',
      'import_preview_image_url'   => 'https://wpocean.com/wp/plumco/wp-content/themes/plumco/screenshot.png',
    ),
  );
}
add_filter( 'pt-ocdi/import_files', 'plumco_import_files' );
...
/**
 * plumco_after_import_setup
 * @return Front Page, Post Page & Menu Set
 */
function plumco_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'plumco_after_import_setup' );

$locations = get_theme_mod( 'nav_menu_locations' );


// Install Demos Menu - Menu Edited
function plumco_core_one_click_page( $default_settings ) {
  $default_settings['parent_slug'] = 'themes.php';
  $default_settings['page_title']  = esc_html__( 'Install Demo', 'plumco-core' );
  $default_settings['menu_title']  = esc_html__( 'Install Demo', 'plumco-core' );
  $default_settings['capability']  = 'import';
  $default_settings['menu_slug']   = 'install_demos';

  return $default_settings;
}
add_filter( 'pt-ocdi/plugin_page_setup', 'plumco_core_one_click_page' );

// Model Popup - Width Increased
function plumco_ocdi_confirmation_dialog_options ( $options ) {
...
add_filter( 'pt-ocdi/confirmation_dialog_options', 'plumco_ocdi_confirmation_dialog_options', 10, 1 );


function plumco_ocdi_plugin_intro_text( $default_text ) {
    $default_text .= '
  <h1>Import Demo</h1>
    <div class="plumco-core_intro-text demo-one-click">
      <div id="poststuff" class="postbox-wrap clearfix">
        ...
        <div class="box-inner important-notes">
          ...
          <div class="inside">
            ...
            <a href="https://wpocean.com/docs/plumco/documentation" class="button-primary" target="_blank">Docs</a>
...
add_filter( 'pt-ocdi/plugin_intro_text', 'plumco_ocdi_plugin_intro_text' );