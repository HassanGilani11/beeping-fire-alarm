 ...
 */
class plumco_footer_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-footer-blog',
      PLUMCO_THEME_NAME_PLUGIN . esc_html__( ': Footer Posts', 'plumco' ),
      array(
        'classname'   => 'footer-post-widget',
        'description' => PLUMCO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays footer posts.', 'plumco' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Footer Posts', 'plumco' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
  ...
  public function widget( $args, $instance ) {
    ...
    if ($plumco_rpw->have_posts()) : while ($plumco_rpw->have_posts()) : $plumco_rpw->the_post();
      ...
      if (!empty( $post_img )) {
        ...
        $post_img = PLUMCO_PLUGIN_IMGS.'/70X80.jpg';
      } ?>
...
add_action( 'widgets_init', function() { register_widget( "plumco_footer_posts" ); } );