...
class plumco_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-navigation-widget',
      PLUMCO_THEME_NAME_PLUGIN . esc_html__( ': Navigation', 'plumco' ),
      array(
        'classname'   => 'link-widget',
        'description' => PLUMCO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays navigations list.', 'plumco' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'plumco' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'plumco' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'plumco' ),
    );
...
add_action( 'widgets_init', function() { register_widget( "plumco_navigation_widget" ); } );
