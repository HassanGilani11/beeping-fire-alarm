 ...
 */
class plumco_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      PLUMCO_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'plumco' ),
      array(
        'classname'   => 'text-widget',
        'description' => PLUMCO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'plumco' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "plumco_text_widget" ); } );