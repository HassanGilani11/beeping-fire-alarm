<?php
/*
 * Elementor Plumco Accordion  Widget
...
class Plumco_Accordion  extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-plumco_accordion';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Accordion ', 'plumco-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Plumco Accordion  widget depended on.
	...
	*/
	...
	/**
	 * Register Plumco Accordion  widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_accordion',
			[
				'label' => esc_html__( 'Accordion  Options', 'plumco-core' ),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __( 'Active Accordion', 'plumco-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'plumco-core' ),
				'label_off' => __( 'Hide', 'plumco-core' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Accordion  Items', 'plumco-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'accordion_title' => esc_html__( 'Accordion ', 'plumco-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Accordion Content', 'plumco-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				'label' => esc_html__( 'Typography', 'plumco-core' ),
				'name' => 'plumco_accordion_content_typography',
...
Plugin::instance()->widgets_manager->register( new Plumco_Accordion () );