...
class Plumco_Tabs  extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-plumco_tabs';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Tabs ', 'plumco-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Plumco Tabs  widget depended on.
	...
	*/
	...
	/**
	 * Register Plumco Tabs  widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => esc_html__( 'Tabs  Options', 'plumco-core' ),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __( 'Active Tabs', 'plumco-core' ),
		...
		$this->add_control(
			'tabsItems_groups',
			[
				'label' => esc_html__( 'Tabs  Items', 'plumco-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tabs_title' => esc_html__( 'Tabs ', 'plumco-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tabs Title', 'plumco-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Background Color', 'plumco-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tabs Content', 'plumco-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
...
Plugin::instance()->widgets_manager->register( new Plumco_Tabs () );