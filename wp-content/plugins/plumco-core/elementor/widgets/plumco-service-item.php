<?php
/*
 * Elementor Plumco ServiceItem Widget
...
class Plumco_ServiceItem extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-plumco_serviceitem';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Work Process', 'plumco-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Plumco ServiceItem widget depended on.
	...
	*/
	...
	/**
	 * Register Plumco ServiceItem widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_ServiceItem',
			[
				'label' => esc_html__( 'ServiceItem Options', 'plumco-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'single_feature_title' => esc_html__( 'Feature', 'plumco-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon', 'plumco-core' ),
		     ...
		     <div class="col-lg-4 col-md-6 col-12">
		        <div class="wpo-solutions-item">
		            ...
		            <div class="wpo-solutions-text">
		            	<?php 
		            		if( $single_feature_title ) { echo '<h2>'.esc_html( $single_feature_title ).'</h2>'; }
	          				if( $single_feature_content ) { echo '<p>'.esc_html( $single_feature_content ).'<p>'; }
	          			?>
		            </div>
		        </div>
	    	</div>
...
Plugin::instance()->widgets_manager->register( new Plumco_ServiceItem() );