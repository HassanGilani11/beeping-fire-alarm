<?php
/*
 * Elementor Plumco Button Widget
...
class Plumco_Button extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-plumco_button';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Button', 'plumco-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Plumco Button widget depended on.
	...
	*/
	...
	/**
	 * Register Plumco Button widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Button',
			[
				'label' => __( 'Button Options', 'plumco-core' ),
			]
		);
		$this->add_control(
			'btn_style',
			[
				'label' => esc_html__( 'Button Style', 'plumco-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'style-one' => esc_html__( 'Style One (Button)', 'plumco-core' ),
					'style-two' => esc_html__( 'Style Two (Link With Text)', 'plumco-core' ),
				],
				'default' => 'style-one',
				'description' => esc_html__( 'Select your Button style.', 'plumco-core' ),
			]
		);
		$this->add_responsive_control(
			'section_alignment',
			[
				'label' => esc_html__( 'Alignment', 'plumco-core' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'plumco-core' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'plumco-core' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'plumco-core' ),
		...
		$this->add_control(
			'btn_paragraph',
			[
				'label' => esc_html__( 'Button/Paragraph Text', 'plumco-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Button Paragraph Text', 'plumco-core' ),
				'placeholder' => esc_html__( 'Type btn Paragraph text here', 'plumco-core' ),
				'label_block' => true,
				'condition' => [
		...
		$this->start_controls_tabs( 'button_style' );
			...
			$this->add_control(
				'link_border_color',
				[
					'label' => esc_html__( 'Link Border Color', 'plumco-core' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
	...
	*/
	protected function render() {
		...
		<div class="<?php echo esc_attr( $btn_wrap_class ); ?>">
			<?php 
  			if( $btn_paragraph ) { echo '<p>'.esc_html( $btn_paragraph ).'</p>'; } 
				echo $button; 
				?>
		</div>
...
Plugin::instance()->widgets_manager->register( new Plumco_Button() );