<?php
/*
 * Elementor Plumco Client Widget
...
class Plumco_Client extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-plumco_client';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Client', 'plumco-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Plumco Client widget depended on.
	...
	*/
	...
	/**
	 * Register Plumco Client widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_client',
			[
				'label' => esc_html__( 'Client Options', 'plumco-core' ),
			]
		);
		...
		$repeater->add_control(
			'client_logo',
			[
				'label' => esc_html__( 'Logo Image', 'plumco-core' ),
		...
		$this->add_control(
			'clientLogos_groups',
			[
				'label' => esc_html__( 'Client Logos', 'plumco-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'client_title' => esc_html__( 'Client', 'plumco-core' ),
					],
	...
	*/
	protected function render() {
    	...
    	<div class="partner-grids owl-carousel owl-theme partners-slider">
...
Plugin::instance()->widgets_manager->register( new Plumco_Client() );