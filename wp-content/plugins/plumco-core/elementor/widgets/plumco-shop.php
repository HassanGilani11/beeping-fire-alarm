<?php
/*
 * Elementor Plumco Product Widget
...
class Plumco_Product extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-plumco_product';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Product', 'plumco-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Plumco Product widget depended on.
	...
	*/
	...
	/**
	 * Register Plumco Product widget controls.
    ...
    if ( $posts ) {
      ...
      $PostID[ __( 'No ID\'s found', 'plumco' ) ] = 0;
		...
		$this->add_control(
			'product_limit',
			[
				'label' => esc_html__( 'Product Limit', 'plumco-core' ),
		...
		$this->start_controls_section(
			'section_meta_style',
			[
				'label' => esc_html__( 'Meta', 'plumco-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
	       ...
	       <?php 
            ...
            <div class="img-cart">
                ...
                <div class="cart-details">
                    <ul>
                        <li>
                        	<a href="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="ajax_add_to_cart theme-btn wpo-cart-btn">
...
Plugin::instance()->widgets_manager->register( new Plumco_Product() );